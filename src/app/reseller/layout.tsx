...
const nav: NavItem[] = [
  ...
  { name: "Notifications", href: "/reseller/notifications", icon: Bell },
                ...
                <AnimatePresence>
                  {showNotif && (
                    <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: 8 }}
                      ...
                      <Link href="/reseller/notifications" onClick={() => setShowNotif(false)} className="block px-4 py-2 text-center text-[10px] text-amber-400 font-semibold hover:bg-white/5">
