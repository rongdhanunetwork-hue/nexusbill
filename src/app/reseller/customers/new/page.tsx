...
export default function ResellerAddCustomerPage() {
  ...
  return (
    <div className="max-w-4xl space-y-6">
      <div className="flex items-center gap-4">
        <Link href="/reseller/customers" className="text-gray-400 hover:text-white transition-colors">
          <ArrowLeft size={22} />
        </Link>
      ...
      >
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-5">
            ...
            <Field label="Phone/User ID *" name="phone" required placeholder="01XXXXXXXXX" type="tel" />
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 gap-5">
            ...
            <Field label="IP Address" name="ipAddress" placeholder="192.168.1.100" />
            <div>
        ...
        <div className="flex gap-4">
          <button
            type="submit"
            disabled={loading}
            className="flex items-center gap-2 px-7 py-3 rounded-xl bg-purple-500/20 text-purple-300 border border-purple-400/40 font-semibold hover:bg-purple-500/30 transition-colors disabled:opacity-50"
          >
            {loading ? <><Loader2 size={18} className="animate-spin" /> Saving...</> : <><Save size={18} /> Save Customer</>}
          </button>
          <Link href="/reseller/customers" className="px-7 py-3 rounded-xl bg-white/5 text-gray-400 border border-white/10 hover:bg-white/10 transition-colors">
            Cancel
          </Link>
        </div>
      </motion.form>
