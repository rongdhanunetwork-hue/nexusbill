        ...
        {allPackages.length === 0 ? (
          ...
          <div key={pkg.id} className="glass-card overflow-hidden relative group">
            ...
            <div className="p-6 relative z-10">
              <div className="w-12 h-12 rounded-xl bg-purple-500/20 text-purple-300 flex items-center justify-center mb-4"><Zap size={24} /></div>
              <h3 className="text-xl font-bold text-white">{pkg.name}</h3>
              <div className="text-sm text-gray-400 mt-1">Speed: {pkg.speed}</div>
              <div className="text-4xl font-bold text-purple-300 mt-5">৳{pkg.price}</div>
