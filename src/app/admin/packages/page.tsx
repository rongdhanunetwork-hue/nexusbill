      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {allPackages.length === 0 ? (
          ...
          <div key={pkg.id} className="glass-card overflow-hidden relative group">
            ...
            <div className="bg-white/5 px-6 py-3 flex justify-end items-center gap-4 relative z-10">
              <Link href={`/admin/packages/${pkg.id}/edit`} className="text-gray-400 hover:text-blue-400 flex items-center gap-1 text-sm font-medium">
