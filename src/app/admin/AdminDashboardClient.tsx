...
export default function AdminDashboardClient({
  ...
  const stats = [
    ...
    { name: "1 Day Expired", value: data.expired1Day, icon: AlertTriangle, color: "text-red-300", glow: "shadow-red-400/40", href: `${basePath}/customers?status=expired_1` },
    { name: "2 Day Expired", value: data.expired2Day, icon: AlertTriangle, color: "text-red-400", glow: "shadow-red-500/40", href: `${basePath}/customers?status=expired_2` },
    { name: "3 Day Expired", value: data.expired3Day, icon: AlertTriangle, color: "text-red-500", glow: "shadow-red-600/40", href: `${basePath}/customers?status=expired_3` },
    { name: "4 Day Expired", value: data.expired4Day, icon: AlertTriangle, color: "text-red-600", glow: "shadow-red-700/40", href: `${basePath}/customers?status=expired_4` },
