  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center p-4">
      <div className="glass-card p-8 text-center max-w-md w-full">
        ...
        <h1 className="text-2xl font-bold text-white mb-3">Customer Panel could not load</h1>
        <p className="text-gray-400 mb-6">Please refresh. If your old sandbox URL is expired, use the latest preview URL.</p>
        <div className="flex gap-3 justify-center">
          <button onClick={reset} className="px-4 py-2 rounded-lg bg-neon-green/20 text-neon-green border border-neon-green/30 inline-flex items-center gap-2">
